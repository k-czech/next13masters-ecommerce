...
export type AssetLinkingCollectionsPageLandingCollectionOrder =
...
export type AssetLinkingCollectionsPageProductCollectionOrder =
  | 'internalName_ASC'
  | 'internalName_DESC'
  | 'name_ASC'
  | 'name_DESC'
...
/** To have SEO-related properties in the pages we render [See type definition](https://app.contentful.com/spaces/oyv61jwh6fda/content_types/componentSeo) */
...
/** To have an entry point for the app [See type definition](https://app.contentful.com/spaces/oyv61jwh6fda/content_types/pageLanding) */
...
/** To output data for a single product [See type definition](https://app.contentful.com/spaces/oyv61jwh6fda/content_types/pageProduct) */
