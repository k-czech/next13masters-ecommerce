...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, slug: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null }> } | null };
...
export type ProductGetByIdQuery = { product?: { id: string, slug: string, name: string, description: string, price: number, images: Array<{ url: string }> } | null };
...
export type GetProductBySlugQuery = { products: Array<{ id: string, slug: string, name: string, description: string, price: number, images: Array<{ url: string }> }> };

export type ProductsGetListItemFragment = { id: string, slug: string, name: string, description: string, price: number, images: Array<{ url: string }> };

export type ProductsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductsGetListQuery = { products: Array<{ id: string, slug: string, name: string, description: string, price: number, images: Array<{ url: string }> }> };
